...
func displaySettings(cs interfaces.ChannelStore, ch *models.Channel) {
	...
	fmt.Printf("Max CPU: %.2f\nMetarr Concurrency: %d\nMin Free Mem: %s\nOutput Directory: %s\nOutput Filetype: %s\nHW acceleration type: %s\nHW acceleration directory: %s\n", ch.MetarrArgs.MaxCPU, ch.MetarrArgs.Concurrency, ch.MetarrArgs.MinFreeMem, ch.MetarrArgs.OutputDir, ch.MetarrArgs.Ext, ch.MetarrArgs.UseGPU, ch.MetarrArgs.GPUDir)
