...
const (
	...
	SettingsYTDLPPreferredVideoCodecs = "ytdlp_preferred_video_codecs"
	SettingsYTDLPPreferredAudioCodecs = "ytdlp_preferred_audio_codecs"
)
...
const (
	...
	MetarrGPUNode                 = "metarr_transcode_gpu_node"
